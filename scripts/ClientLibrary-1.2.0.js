...
(function ($) {
    ...
    $.fn.HousingLoanCalculator = function (options) {
        ...
        return this.each(function () {
            ...
            if (settings.theme == "bluehorizon") {
                imgPathTheme = "themes/Images/BlueHorizon";
            }
            else if (settings.theme == "greenforest") {
                imgPathTheme = "themes/Images/GreenForest";
            }
            else if (settings.theme == "grayscale") {
                imgPathTheme = "themes/Images/Grayscale";
            }
            else if (settings.theme == "blackmatter") {
                imgPathTheme = "themes/Images/BlackMatter";
            }
            else if (settings.theme == "redroyale") {
                imgPathTheme = "themes/Images/RedRoyale";
            }
            else if (settings.theme == "browncrown") {
                imgPathTheme = "themes/Images/BrownCrown";
            }
            ...
            var paymentTermsValues = [12, 18, 24, 36, 48, 60];
            ...
            head = '<div id="C88ECMVehicleLoanCalcuContainer"><div class="loanCalculatorMainContent"><div class="top"><div class="topLeft"><label id="LoanCalculatorHeaderName" class="loanCalculatortitle">' + settings.title + '</label></div> <div class="topCenter">  &nbsp;</div><div class="topRight"> &nbsp;</div> </div><div class="middle"> <div class="middleLeft">&nbsp;</div><div class="middleCenter"><div id="LoanCalculatorIcon" class="objectIcon"></div><div id="LoanCalculatorTitle" class="objectTitle">Housing Loan Calculator</div><div id="LoanCalculatorDescription" class="objectDescription">loan Calculator................</div>';
            ...
            if (settings.hidePaymentTerms != true) {
                ...
                if (settings.lockPaymentTerms) {
                    formItems += '<select name="paymentTermSelect" id="PaymentTermValueSelect" class="propertyValueTextBox disabledSelect" onchange="CalculateLoan();" disabled>';
                }
                else {
            ...
            //class dependent
            computationHeaderMsg = 'Own this car for only:';
            ...
            if (!settings.hideMarketing) {
                if (settings.marketingImgURL == "") {
                    ...
                    computation += '<div id="ComputationContainer" style="display:none;"> <div id="ComputationHeader"> <div id="ComputationHeaderSec1"><img src="' + settings.marketingImgURL + '/driveDream.png" /></div>  </div> ';
                }

            }
            else {
                computation += '<div id="ComputationContainer" style="display:none;"> <div id="ComputationHeader"> <div id="ComputationHeaderSec1"><span>' + computationHeaderMsg + '</span></div>  </div> ';
            }
            ...
            last = '<div class="middleRight"> &nbsp;</div></div><div class="bottom"><div class="bottomLeft"> &nbsp;</div><div class="bottomCenter"> &nbsp;</div><div class="bottomRight">&nbsp;</div> </div></div></div>';

			last += '<div class="middleRight"> ';
			
			//enter div form captureEvents!!!!!!!!!
			last += '<div id="CalculatorBasicFormCapture"><div id="FormCaptureHead">Kindly fill up the following information and an agent will get in touch with you for your further inquiries.</div><div><span>Full Name:</span></div><div><input type="text" name="fullname"></div><div><span>Email Address</span></div><div><input type="text" name="email"></div><div><span>Contact Number:</span></div><div><input type="text" name="contactno"></div><div id="CalculatorFormCaptureButton"><a href="javascript:void(0);" onclick="CalculatorFormCaptureButton_Clicked()" >Submit</a></div></div>';
			last += '<div id="CalculatorBasicFormCaptureSuccess"><div id="FormCaptureSuccessHead">Thank you! You may continue browsing other products or do another calculation as you please.</div> <div id="CalculatorFormContinueButton"><a href="javascript:void(0);" onclick="CalculatorFormContinueButton_Clicked()" >Continue</a></div></div>';
			
			
			last += '</div> </div><div class="bottom"><div class="bottomLeft">&nbsp;</div><div class="bottomCenter">&nbsp;</div><div class="bottomRight">&nbsp;</div> </div></div>';
            ...
            if (($(this).width()) < 450) {
                $("#C88ECMVehicleLoanCalcuContainer").addClass('minCalcuContainer');
            }
...
function RenderLoanCalculator(theme, title, amountOfLoan, width) {
    ...
    head = '<div class="loanCalculatorMainContent"><div class="top"><div class="topLeft"><label id="LoanCalculatorHeaderName" class="loanCalculatortitle">' + title + '</label> </div> <div class="topCenter"><span id="CalculatorLogo"></span> &nbsp;</div><div class="topRight"> &nbsp;</div> </div><div class="middle"> <div class="middleLeft">&nbsp;</div><div class="middleCenter"><div id="LoanCalculatorIcon" class="objectIcon"></div><div id="LoanCalculatorTitle" class="objectTitle">Housing Loan Calculator</div><div id="LoanCalculatorDescription" class="objectDescription">loan Calculator................</div>';
